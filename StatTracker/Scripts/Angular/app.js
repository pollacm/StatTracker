...
myApp
    .config(["$routeProvider", function ($routeProvider) {
        ...
        $routeProvider
            ...
            .when("/test", { templateUrl: "/test/index", controller: "TestController" })
    ...
    .controller("HomeController", ["$scope", "$route", "$routeParams", "$location", function ($scope, $route, $routeParams, $location) {
